...
export class Player {
  ...
  draw(ctx) {
    ...
    ctx.lineWidth = CONFIG.PLAYER.DRAW.OUTLINE_WIDTH;
    ctx.stroke();
    ...
    ctx.ellipse(
      ...
      CONFIG.PLAYER.DRAW.COCKPIT_RX,
      CONFIG.PLAYER.DRAW.COCKPIT_RY,
      0,
      0,
      PI2
    );
    ...
    ctx.fillRect(
      centerX - CONFIG.PLAYER.DRAW.GUN_WIDTH / 2,
      this.y + CONFIG.PLAYER.DRAW.GUN_OFFSET_Y,
      CONFIG.PLAYER.DRAW.GUN_WIDTH,
      CONFIG.PLAYER.DRAW.GUN_HEIGHT
    );
    ctx.restore();
  }
