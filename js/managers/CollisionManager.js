...
export class CollisionManager {
    ...
    static intersects(rect1, rect2) {
        /** @type {Rect} */
        const a = /** @type {any} */ ((rect1 && typeof rect1 === 'object' && 'getBounds' in rect1 && typeof /** @type {any} */(rect1).getBounds === 'function')
            ? /** @type {any} */(/** @type {any} */(rect1).getBounds())
            : rect1);
        /** @type {Rect} */
        const b = /** @type {any} */ ((rect2 && typeof rect2 === 'object' && 'getBounds' in rect2 && typeof /** @type {any} */(rect2).getBounds === 'function')
    ...
    const put = (ax, ay, a) => {
            ...
            if (!arr) { arr = CollisionManager._getArr(); grid.set(key, arr); }
            arr.push(a);
        };
