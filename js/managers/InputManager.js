...
export class InputManager {
	...
	static setup(canvas, gameInfo, gameOverScreen, startBtn, restartBtn, handlers) {
		...
		gameInfo.addEventListener('touchstart', handlers.handleStartScreenFocusGuard, { passive: false });
		...
		gameOverScreen.addEventListener('touchstart', handlers.handleGameOverFocusGuard, { passive: false });
